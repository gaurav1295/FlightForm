var airportsss=[ {
            ...
            var getcountry= function(){
                var countries=[];
                airportsss.forEach(function(airport){
            ...
            var showairportlist=function(){
                results = _.take(airportsss, 500);
                results.forEach(function(airport){
        
                    $("#airportlistul").append('<li class="highlight" data-iata="'+airport.iata+'" data-country="'+airport.country+'" data-name="'+airport.name+'">\
             ...
             var showcountrylist=function(){
                var countrylist=getcountry();
                countrylist.forEach(function(country){
                    $("#countrylistul").append('<li  class="highlight1"  data-country="'+country+'">\
                        <span>'+country+'</span>\
                    ');
                })
            }
            ...
            var showairportlistoncountryselected=function(data){
                var result=[];
                var pusher={};
                            airportsss.forEach(function(airport){
