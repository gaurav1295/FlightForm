var airportsss1=[ {
                ...
                , {
                    name: "Ataturk", city: "Istanbul", country: "Turkey", iata: "IST"
                }
                , {
                ...
                , {
                    name: "Dubai Intl airport boading point xnb", city: "Dubai", country: "United Arab Emirates", iata: "XNB"
                }
                , {
            ...
            var getcountry1= function(){
                var countries=[];
                airportsss1.forEach(function(airport){
            ...
            var getselect2data1=function(){
                var rawdata=getcountry1();
                var formatteddata=[];
            ...
            var showairportlist1=function(){
                results = _.take(airportsss1, 500);
                results.forEach(function(airport){
        
                    $("#airportlistul1").append('<li class="highlight" data-iata="'+airport.iata+'" data-country="'+airport.country+'" data-name="'+airport.name+'">\
                        <span class="airportcity">'+airport.city+'</span><span class="countryName"> , '+airport.country+'</span>\<br>\
                        <span class="airportName">'+airport.name+' ('+airport.iata+')</span><br>\
                    ');
                })
            }


             var showcountrylist1=function(){
                var countrylist=getcountry1();
                countrylist.forEach(function(country){
                    $("#countrylistul1").append('<li  class="highlight1"  data-country="'+country+'">\
                        <span>'+country+'</span>\
                    ');
                })
            }
            ...
            var showairportlistoncountryselected1=function(data){
                var result=[];
                var pusher={};
                            airportsss1.forEach(function(airport){
                                if(airport.country==data){
                                    pusher=airport;
                                    result.push(pusher);
                                }
                            })
